/*
    ...
    OpenGL loader generated by glad 0.1.34 on Wed Feb  3 20:18:29 2021.
    ...
    Commandline:
        --profile="compatibility" --api="gl=3.3" --generator="c-debug" --spec="gl" --local-files --extensions="GL_KHR_debug"
    Online:
