...
static inline v2
V2Scalar(float Scalar)
{
    return V2(Scalar, Scalar);
}

static inline v3
V3Scalar(float Scalar)
{
    return V3(Scalar, Scalar, Scalar);
}

static inline v4
V4Scalar(float Scalar)
{
    return V4(Scalar, Scalar, Scalar, Scalar);
}
